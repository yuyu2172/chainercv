from chainercv.links.model.feature_extraction_predictor import FeatureExtractionPredictor  # NOQA
...
from chainercv.links.model.inception import InceptionV1  # NOQA
